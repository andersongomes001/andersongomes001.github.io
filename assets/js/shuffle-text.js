(function (global, factory) {
  ...
  var ShuffleText = /** @class */ (function () {
      ...
      function ShuffleText(element) {
           ...
           */
          //this.sourceRandomCharacter = ['0x41', '0x42', '0x43', '0x44', '0x45', '0x46', '0x47', '0x48', '0x49', '0x4a', '0x4b', '0x4c', '0x4d', '0x4e', '0x4f', '0x50', '0x51', '0x52', '0x53', '0x54', '0x55', '0x56', '0x57', '0x58', '0x59', '0x5a', '0x31', '0x32', '0x33', '0x34', '0x35', '0x36', '0x37', '0x38', '0x39', '0x30'];
      ...
      ShuffleText.prototype._onInterval = function () {
          ...
          for (var i = 0; i < this._originalLength; i++) {
              if (percent >= this._randomIndex[i]) {
                  ...
                  //str += this.sourceRandomCharacter[Math.floor(Math.random() * (this.sourceRandomCharacter.length))];
              }
          }
          if (percent > 1) {
